...
router.get("/", isAdmin, accountControllers.getAccounts);
router.post("/", validateCreateAccount, createAccount);

router.post("/admin", isAdmin, accountControllers.createAdminAccount);

router.get("/@me", isAuthenticated, accountControllers.getMyAccount);
router.get("/:id", isAdmin, accountControllers.getAccountById);
router.patch("/:id", isAdmin, accountControllers.editAccount);
router.delete("/:id", isAdmin, accountControllers.deleteAccount);
